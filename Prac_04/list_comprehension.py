...
uppercase_fullnames = [name.upper() for name in full_names]
print(uppercase_fullnames)
...
# decend_number = [int.des(almost_number) for almost_number in almost_numbers]
# print(decend_number)
...
small_numbers = [number for number in numbers if number <9 ]
print(small_numbers)